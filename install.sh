#!/usr/bin/env sh
# Universal installer for reposecure. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/reposecure.git"
echo "Installing reposecure ..."
