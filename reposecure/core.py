"""REPOSECURE core — One-shot repo security posture grade (secrets/CI/branch rules/deps)."""
...
RULES = [
    ("REP-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("REP-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("REP-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
