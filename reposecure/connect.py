"""Native cognis-connect emit for reposecure — forward findings to any platform.

Maps reposecure's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    reposecure ... --format json | reposecure-emit --to stix
    reposecure-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
